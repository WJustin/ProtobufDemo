...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/ProtobufDemo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Justin.Wang' => 'rongchao.wang@ele.me' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/ProtobufDemo.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'ProtobufDemo' => ['ProtobufDemo/Assets/*.png']
  # }
